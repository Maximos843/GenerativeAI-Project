...
from src.utils.base import TorchGenerator
from src.models.gan import GANModule

from src.models.transformer_blocks import Classification, TransformerEncoderBlock
...
class TransformerDiscriminator(nn.Module):
    """
    Attributes:
        sequence_length (int): A window size to train the generator.
        embedding_dim (int): The embedding dimension equals length of target_columns.
        conditional_dim (int): The amount of conditional columns.
        attention_dropout (float): A dropout for MultiHeadAttention layers.
        feed_dropout (flaot): A dropout for FeedForward layers.
        depth (int): Amount of transformer blocks.
        n_classes (int): Amount of classes for disriminator classification head.
        num_heads(int): Amount of heads in transformer layer.
...
class TransformerGenerator(nn.Module):
    ...
    Attributes:
        ...
        feed_dropout (flaot): A dropout for FeedForward layers.
        depth (int): Amount of transformer blocks.
        channels (int): Result embedding dim with target columns and conditional.
        num_heads(int): Amount of heads in transformer layer.
        transformer_dim (int): Embedding dim of transformer layers.
     """
    def __init__(self,
